                    ...
                    <>
                        ...
                        {result.result == "selected" &&
                            <>
                                ...
                                <p className={styles.welcome}>Be sure to join our Main WhatsApp Group <a rel="noreferrer" href="https://chat.whatsapp.com/HCYn7NsdESe6vNvLUmH8Np" target="_blank">here</a>!</p>
                                <p className={styles.welcome}>
                                    And also join the group for CYSCOM's {dept} Team 
                                    {
                                        dept == "Web Development" && <a rel="noreferrer" target="_blank" href="https://chat.whatsapp.com/LEJ5X8PAdXe3l5hsBB6asH"> here</a>
                                    }
                                    {
                                        dept == "Technical" && <a rel="noreferrer" target="_blank" href="https://chat.whatsapp.com/EdzykuzuVFT2R2CFjlobOm"> here</a>
                                    }
                                    {
                                        dept == "Operations" && <a rel="noreferrer" target="_blank" href="https://chat.whatsapp.com/JCpFAr8iS9Y8qH2mT1ullt"> here</a>
                                    }
                                    {
                                        dept == "Design" && <a rel="noreferrer" target="_blank" href="https://chat.whatsapp.com/EB9lSMiaWaM5sAVGSGmUK0"> here</a>
                                    }
                                    !
                                </p>
